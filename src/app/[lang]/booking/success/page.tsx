  ...
  return (
    <main style={{ padding: '6rem 2rem', maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
      ...
      <div style={{ backgroundColor: 'var(--color-white)', padding: '3rem', borderRadius: '8px', boxShadow: 'var(--shadow-md)', textAlign: 'left' }}>
        ...
        <p style={{ margin: '0.5rem 0' }}><strong>Check-in:</strong> {reservation.checkInDate.toLocaleDateString('es-HN', { timeZone: 'UTC' })}</p>
        <p style={{ margin: '0.5rem 0' }}><strong>Check-out:</strong> {reservation.checkOutDate.toLocaleDateString('es-HN', { timeZone: 'UTC' })}</p>
